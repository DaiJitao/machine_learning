...
ltp_data_dir = r'D:\qichezhijia\workspace\pycharm\tokenizer\models\ltp\ltp_data_v3.4.0'
cws_model_path = os.path.join(ltp_data_dir, 'cws.model')  # 分词模型路径，模型名称为`cws.model`

segmentor = Segmentor()
segmentor.load(cws_model_path)

stop_words_file = r"D:\qichezhijia\workspace\pycharm\tokenizer\token_data\stopwords_amend.txt"
...
if __name__ == '__main__':
    tb_richmedia_pool = "richmedia_ab"
    infile = r"C:/Users/daijitao/Desktop/upload/" + tb_richmedia_pool
    outfile = r"C:/Users/daijitao/Desktop/upload/out_" + tb_richmedia_pool
