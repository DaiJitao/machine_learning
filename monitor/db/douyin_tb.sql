...
--
-- Table structure for table `douyin_tb`
--

DROP TABLE IF EXISTS `douyin_tb`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `douyin_tb` (
...
--
-- Dumping data for table `douyin_tb`
--

LOCK TABLES `douyin_tb` WRITE;
/*!40000 ALTER TABLE `douyin_tb` DISABLE KEYS */;
/*!40000 ALTER TABLE `douyin_tb` ENABLE KEYS */;
UNLOCK TABLES;
